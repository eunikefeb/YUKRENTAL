...
<link rel="stylesheet" href="style.css">
  <head>
    ...
    <title>Admin's Dashboard - Home</title>
    <link
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-3">Nama Jenis Motor</th>
                  ...
                  <tbody
                    ...
                    <td class="px-4 py-3">  
                      <p class="font-semibold"><?php echo $row['id_jenis_motor']; ?></p>
                    </td>
                    <td class="px-4 py-3">
                      <p class="font-semibold"><?php echo $row['nama_jenis_motor']; ?></p>
                    </td>
                    <td class="text-gray-700 dark:text-gray-400">
                      <p class="font-semibold"><?php echo $row['deskripsi']; ?></p>
                    </td>
                    ...
                    <span
                          ...
                          >
                          <a href="jenis_motor.php?page=customer&action=edit&id_jenis_motor=<?php echo $row['id_jenis_motor']; ?>">Edit</a>
                      </span>         
                  </td>  
                  <td class="px-4 py-3">
                        <span
            ...
            <div class="card">
              <div class="card-header">
                ...
                href="jenis_motor.php?page=jenis_motor&action=add">Add New Jenis Motor
                </a>
                </div>
              </div><br>
              <?php
              ...
              <form action="crud_jenis_motor.php" method="post">
                  <input type="hidden" name="id_jenis_motor" value="<?php echo $jenis_motor['id_jenis_motor']; ?>">

                  <label class="my-6 text-sm font-semibold text-gray-700 dark:text-gray-200" for="nama_jenis_motor">Nama Jenis Motor:</label>
                  <input 
                  class="w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input" 
                  type="text" name="nama_jenis_motor" value="<?php echo $jenis_motor['nama_jenis_motor']; ?>" required><br>

                  <label class="my-6 text-sm font-semibold text-gray-700 dark:text-gray-200" for="deskripsi">Deskripsi:</label>
                  <input 
                  class="w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input" 
                  type="deskripsi" name="deskripsi" value="<?php echo $jenis_motor['deskripsi']; ?>" required><br>
